...
function NotifyForm({ onSuccess }) {
  ...
  function onSubmit(e) {
    handleSubmit(
      e,
      { access_key: ACCESS_KEY, botcheck: '', Type: 'Single Game Ticket', name, email },
...
export default function SingleCheckoutClient() {
    ...
    <>
      <header style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
        <div className="hero" style={{ position: 'relative', zIndex: 2, maxWidth: 980, padding: '0 1rem' }}>
          <h1>SINGLE GAME TICKET</h1>
          <p className="tagline">For Ballers Who Create</p>
          <p className="subtext">One game. Full experience. $10.</p>
        </div>
      </header>
      ...
      <main style={{ maxWidth: 600, margin: '2.8rem auto 4rem', padding: '0 1.25rem', textAlign: 'center' }}>
        ...
        <section style={{ margin: '3rem 0' }}>
          ...
          <p className="price" style={{ fontSize: '2rem', margin: '1rem 0' }}>$10</p>
          <p style={{ margin: '0.6rem auto', maxWidth: '70ch', lineHeight: 1.8 }}>
            Access to one regular season match. Choose your game, show up, and experience live TekkyFutbol.
          </p>
          <ul className="bullet-list" style={{ textAlign: 'left', display: 'inline-block' }}>
            <li>Entry to one regular season match</li>
            <li>General admission seating</li>
            <li>Full match access from kickoff to final whistle</li>
          </ul>
      ...
      <Modal isOpen={success} onClose={() => setSuccess(false)}>
        ...
        <p className="subtext">We&#39;ll notify you when single game tickets go live.</p>
