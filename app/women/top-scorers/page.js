...
export const metadata = {
  title: "TekkyFutbol Shop — Women Top Scorers",
  description: 'Goals change games. Creators change seasons.',
};

const ranks = [1, 2, 3, 4, 5];

export default function WomenTopScorersPage() {
  return (
    <>
      ...
      <main className="spaced-content" style={{ maxWidth: 1080, margin: '2.8rem auto 4rem', padding: '0 1.25rem', textAlign: 'center' }}>
        ...
        <div className="tabs">
          <Link className="cta" href="/top-scorers">Men</Link>
          <Link className="cta active" href="/women/top-scorers">Women</Link>
        </div>
        ...
        <div className="sec-cta">
          ...
          <Link className="cta" href="/women/standings">VIEW FULL STANDINGS</Link>
        </div>
      </main>
    </>
  );
