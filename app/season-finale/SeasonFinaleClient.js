  ...
  return (
    <div className="finale-page">
      <header className="finale-hero">
        <div className="finale-hero-split" aria-hidden="true">
          <div className="finale-hero-premium" />
      ...
      <main className="finale-main tight-list-content">
        <div className="finale-split-rule" aria-hidden="true"><span /><span /></div>

        <section id="definition" className="finale-panel finale-panel--street">
          <h2>THE DEFINING MOMENT</h2>
          <p>The TekkyFutbol Season Finale concludes Dominion — the elimination phase of the league.</p>
          <p>Only the top teams from each division earn the right to compete on Championship Day.</p>
          <p>This is where the margins disappear.</p>
          <p>Where structure meets creativity. Where champions are earned.</p>
        ...
        <section id="format" className="finale-panel finale-panel--street">
          <h2>CHAMPIONSHIP FORMAT</h2>
          <p>The Dominion playoffs are decided in a single Championship Day.</p>
          <p>Semifinals. Third place. Championship.</p>
          <p>Four matches decide everything.</p>
          <p>Format</p>
          ...
          <p>One league. One standard. One final stage.</p>
        </section>

        <div className="finale-split-rule" aria-hidden="true"><span /><span /></div>

        <section id="accommodation" className="finale-panel finale-panel--premium">
          <h2>CHAMPIONSHIP WEEKEND ACCOMMODATION</h2>
          <p>Qualified Dominion players receive complimentary hotel accommodations for Championship Weekend.</p>
          <p>Equal footing. Professional standard. No excuses.</p>
          <p>The focus stays on performance.</p>
        </section>
        ...
        <section id="experience" className="finale-panel finale-panel--mix">
          <div className="finale-mix-premium">
            <h2>CHAMPIONSHIP DAY EXPERIENCE</h2>
            <p>Championship Day is designed as a street football festival.</p>
            <p>The trophy is lifted on the court. The culture is celebrated together.</p>
          </div>
          <div className="finale-mix-street">
            <p>Expect:</p>
            <ul className="bullet-list centered">
        ...
        <section id="whyItMatters" className="finale-panel finale-panel--premium">
          <h2>WHY IT MATTERS</h2>
          <p>The Season Finale represents the highest expression of TekkyFutbol.</p>
          <ul className="finale-pillars">
            <li>Competitive excellence</li>
            <li>Creative identity</li>
            <li>Community presence</li>
            <li>Cultural relevance</li>
          </ul>
          <p>For players — it is earned.</p>
          <p>For partners — it is alignment.</p>
          <p>For the league — it is the standard.</p>
        </section>

        <div className="finale-split-rule" aria-hidden="true"><span /><span /></div>

        <section id="partnerAndBrand" className="finale-panel finale-panel--premium">
          <h2>PARTNER & SPONSOR OPPORTUNITIES</h2>
          <p>Brands can engage through:</p>
          <ul className="bullet-list centered">
        ...
        <section id="requestAccess" className="finale-panel finale-panel--street">
          <h2>REQUEST ACCESS</h2>
          <p>Interested in attending or collaborating?</p>
          <p>Access to the TekkyFutbol Season Finale Experience is limited.</p>
          <p>Attendance is confirmed in advance to preserve the atmosphere of Championship Day.</p>
          <div className="sec-cta">
            <button className="cta" onClick={() => setAccessOpen(true)}>REQUEST ACCESS</button>
          </div>
        </section>
        ...
        <div className="sec-cta finale-cta-row">
          <button className="cta" onClick={() => setSponsorOpen(true)}>Become a Sponsor</button>
