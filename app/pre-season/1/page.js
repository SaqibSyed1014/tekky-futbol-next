...
export const metadata = {
  title: 'TekkyFutbol — Pre-Season 1',
  description: 'TekkyFutbol Pre-Season matchday 1 results.',
};

export default function PreSeason1Page() {
  return (
    <>
      <header style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
        <div className="hero" style={{ position: 'relative', zIndex: 2, maxWidth: 980, padding: '0 1rem' }}>
          ...
          <p className="subtext">Matchday 1 — Sunday, March 9</p>
        </div>
      </header>
      ...
      <main style={{ maxWidth: 1080, margin: '2.8rem auto 4rem', padding: '0 1.25rem', textAlign: 'center' }}>
        ...
        <div className="sec-cta">
          <Link className="cta" href="/pre-season/2">Pre-Season 2</Link>
